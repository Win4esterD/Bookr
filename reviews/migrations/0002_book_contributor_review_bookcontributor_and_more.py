# Generated by Django 4.0.2 on 2022-04-03 15:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text='The contact e-mail for the contributor.', max_length=254)),
            ],
        ),
        migrations.CreateModel(
            name='Review',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('AUTHOR', 'author'), ('CO_AUTHOR', 'Co-author'), ('EDITOR', 'Editor')], max_length=20, verbose_name='The role the contributor had in this book')),
