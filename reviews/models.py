...
class Publisher(models.Model):
    ...
    email = models.EmailField(help_text="The publisher's e-mail adress.")
...
class Contributor(models.Model):
    ...
    def initialled_name(self, last_names, first_names):
        self.first_names = ''
        for letter in first_names:
            if letter.isupper():
                self.first_names += letter
        return f"{self.last_names}, {self.first_names}"

    def __str__(self):
        return self.initialled_name(self.last_names, self.first_names)
...
class BookContributor(models.Model):
    ...
    role = models.CharField(verbose_name="The role the contributor had in this book", \
